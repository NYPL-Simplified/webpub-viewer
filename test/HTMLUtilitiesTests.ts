...
describe("IFrameUtilities", () => {
  ...
  beforeEach(() => {
    ...
    (iframe.contentDocument as any).write(
  ...
  describe("#findIframeElement", () => {
    it("should return existing element", () => {
      const result = HTMLUtilities.findIframeElement(
        iframe.contentDocument as any,
        "div"
      );
  ...
  describe("#findRequiredIframeElement", () => {
    it("should return existing element", () => {
      const result = HTMLUtilities.findRequiredIframeElement(
        iframe.contentDocument,
        "div"
      );
      expect(result).to.equal(iframeElement);
    ...
    it("should raise exception if element does not exist", () => {
      const test = () => {
        HTMLUtilities.findRequiredIframeElement(
          iframe.contentDocument as any,
          "p"
        );
      };
