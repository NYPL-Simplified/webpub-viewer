...
describe("BookSettings", () => {
  ...
  describe("#renderControls", () => {
    it("renders a button for each font", async () => {
      ...
      let font1Button = element.querySelector(
        "button[class='font1 active']"
      ) as HTMLButtonElement;
      expect(font1Button.getAttribute("aria-label")).to.equal(
        "Font 1 font enabled"
      );
      let font2Button = element.querySelector(
        "button[class='font2']"
      ) as HTMLButtonElement;
      expect(font2Button.getAttribute("aria-label")).to.equal(
        "Font 2 font disabled"
      );
      const font3Button = element.querySelector(
        "button[class='font3']"
      ) as HTMLButtonElement;
      expect(font3Button.getAttribute("aria-label")).to.equal(
        "Font 3 font disabled"
      );
      ...
      settings.renderControls(element);
      font1Button = element.querySelector(
        "button[class='font1 active']"
      ) as HTMLButtonElement;
      expect(font1Button).to.be.null;
      font2Button = element.querySelector(
        "button[class='font2']"
      ) as HTMLButtonElement;
    ...
    it("renders a button for each theme", async () => {
      ...
      let theme1Button = element.querySelector(
        "button[class='theme1 active']"
      ) as HTMLButtonElement;
      expect(theme1Button.getAttribute("aria-label")).to.equal(
        "Theme 1 mode enabled"
      );
      let theme2Button = element.querySelector(
        "button[class='theme2']"
      ) as HTMLButtonElement;
      expect(theme2Button.getAttribute("aria-label")).to.equal(
        "Theme 2 mode disabled"
      );
      const theme3Button = element.querySelector(
        "button[class='theme3']"
      ) as HTMLButtonElement;
      expect(theme3Button.getAttribute("aria-label")).to.equal(
        "Theme 3 mode disabled"
      );
      ...
      settings.renderControls(element);
      theme1Button = element.querySelector(
        "button[class='theme1 active']"
      ) as HTMLButtonElement;
      expect(theme1Button).to.be.null;
      theme2Button = element.querySelector(
        "button[class='theme2']"
      ) as HTMLButtonElement;
    ...
    it("renders a button for each view", async () => {
      ...
      let view1Button = element.querySelector(
        "button[class='view1 active']"
      ) as HTMLButtonElement;
      expect(view1Button.innerHTML).to.contain("View 1");
      expect(view1Button.getAttribute("aria-label")).to.equal(
        "View 1 mode enabled"
      );
      let view2Button = element.querySelector(
        "button[class=view2]"
      ) as HTMLButtonElement;
      expect(view2Button.innerHTML).to.contain("View 2");
      expect(view2Button.getAttribute("aria-label")).to.equal(
        "View 2 mode disabled"
      );
      ...
      settings.renderControls(element);
      view1Button = element.querySelector(
        "button[class='view1 active']"
      ) as HTMLButtonElement;
      expect(view1Button).to.be.null;
      view2Button = element.querySelector(
        "button[class=view2]"
      ) as HTMLButtonElement;
    ...
    it("changes font when a font button is clicked", async () => {
      ...
      const font1Button = element.querySelector(
        "button[class='font1 active']"
      ) as HTMLButtonElement;
      const font2Button = element.querySelector(
        "button[class='font2']"
      ) as HTMLButtonElement;
    ...
    it("renders font size increase and decrease buttons", async () => {
      ...
      let decreaseButton = element.querySelector(
        "button[class='decrease']"
      ) as HTMLButtonElement;
      expect(decreaseButton).to.be.ok;
      let increaseButton = element.querySelector(
      ...
      settings.renderControls(element);
      decreaseButton = element.querySelector(
        "button[class='decrease']"
      ) as HTMLButtonElement;
      expect(decreaseButton).to.be.null;
      increaseButton = element.querySelector(
        "button[class=increase]"
      ) as HTMLButtonElement;
    ...
    it("changes theme when a theme button is clicked", async () => {
      ...
      const theme1Button = element.querySelector(
        "button[class='theme1 active']"
      ) as HTMLButtonElement;
      const theme2Button = element.querySelector(
        "button[class='theme2']"
      ) as HTMLButtonElement;
      ...
      expect(theme1Button.getAttribute("aria-label")).to.equal(
        "Theme 1 mode disabled"
      );
      expect(theme2Button.getAttribute("aria-label")).to.equal(
        "Theme 2 mode enabled"
      );
    ...
    it("changes view when a view button is clicked", async () => {
      ...
      const view1Button = element.querySelector(
        "button[class='view1 active']"
      ) as HTMLButtonElement;
      const view2Button = element.querySelector(
        "button[class=view2]"
      ) as HTMLButtonElement;
    ...
    it("renders offline status", async () => {
      ...
      const offlineStatus = element.querySelector(
