...
define("IconLib", ["require", "exports"], function (require, exports) {
  ...
  var iconUse = function (id, classAttr) {
    return (
...
define("BookSettings", [
  ...
  "HTMLUtilities",
  "IconLib",
], function (require, exports, HTMLUtilities, IconLib) {
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  var template = function (sections) {
    return (
  ...
  var sectionTemplate = function (options) {
    return (
        ...
        return __generator(this, function (_f) {
          switch (_f.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.store.get(BookSettings.SELECTED_FONT_KEY),
              ];
            case 1:
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                this.store.get(BookSettings.SELECTED_FONT_SIZE_KEY),
              ];
            case 3:
            ...
            case 4:
              ...
              return [
                4 /*yield*/,
                this.store.get(BookSettings.SELECTED_THEME_KEY),
              ];
            case 5:
            ...
            case 6:
              ...
              return [
                4 /*yield*/,
                this.store.get(BookSettings.SELECTED_VIEW_KEY),
              ];
            case 7:
    ...
    BookSettings.prototype.renderControls = function (element) {
      ...
      if (this.bookThemes.length > 1) {
        for (var _d = 0, _e = this.bookThemes; _d < _e.length; _d++) {
          var bookTheme = _e[_d];
          this.themeButtons[bookTheme.name] = HTMLUtilities.findRequiredElement(
            element,
    ...
    BookSettings.prototype.setupEvents = function () {
      ...
      if (this.fontSizes.length > 1) {
        this.fontSizeButtons["decrease"].addEventListener("click", function (
          ...
          var currentFontSizeIndex = _this.fontSizes.indexOf(
            _this.selectedFontSize
          );
    ...
    BookSettings.prototype.storeSelectedFont = function (font) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            this.store.set(BookSettings.SELECTED_FONT_KEY, font.name),
          ];
        });
      });
    };
    BookSettings.prototype.storeSelectedFontSize = function (fontSize) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            this.store.set(BookSettings.SELECTED_FONT_SIZE_KEY, fontSize),
          ];
        });
      });
    };
    BookSettings.prototype.storeSelectedTheme = function (theme) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            this.store.set(BookSettings.SELECTED_THEME_KEY, theme.name),
          ];
        });
      });
    };
    BookSettings.prototype.storeSelectedView = function (view) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            this.store.set(BookSettings.SELECTED_VIEW_KEY, view.name),
          ];
        });
      });
    };
...
define("PaginatedBookView", ["require", "exports"], function (
  require,
  exports
) {
  "use strict";
...
define("ColumnsPaginatedBookView", [
  "require",
  "exports",
  "HTMLUtilities",
], function (require, exports, HTMLUtilities) {
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  // import * as BrowserUtilities from "./BrowserUtilities.js";
  var ColumnsPaginatedBookView = /** @class */ (function () {
    ...
    ColumnsPaginatedBookView.prototype.start = function (position) {
      ...
      var body = HTMLUtilities.findRequiredIframeElement(
      ...
      var head = HTMLUtilities.findIframeElement(
        this.bookElement.contentDocument,
        "head"
      );
      if (head) {
...
define("DayTheme", ["require", "exports", "HTMLUtilities"], function (
  require,
  exports,
  HTMLUtilities
) {
...
define("EventHandler", ["require", "exports", "BrowserUtilities"], function (
  require,
  exports,
  BrowserUtilities
) {
  ...
  var EventHandler = /** @class */ (function () {
    function EventHandler() {
      ...
      this.handleMouseEventEnd = function (event) {
        ...
        var xDevicePixels =
          (_this.pendingMouseEventStart.clientX - event.clientX) /
          devicePixelRatio;
        var yDevicePixels =
          (_this.pendingMouseEventStart.clientY - event.clientY) /
          devicePixelRatio;
        // Is the end event in the same place as the start event?
        if (
          Math.abs(xDevicePixels) < EventHandler.CLICK_PIXEL_TOLERANCE &&
          Math.abs(yDevicePixels) < EventHandler.CLICK_PIXEL_TOLERANCE
        ) {
      ...
      this.handleTouchEventEnd = function (event) {
        ...
        // Is the end event in the same place as the start event?
        if (
          Math.abs(xDevicePixels) < EventHandler.TAP_PIXEL_TOLERANCE &&
          Math.abs(yDevicePixels) < EventHandler.TAP_PIXEL_TOLERANCE
        ) {
          ...
          if (
            event.timeStamp - _this.pendingTouchEventStart.timeStamp >
            EventHandler.LONG_PRESS_MS
          ) {
...
define("PublisherFont", ["require", "exports", "HTMLUtilities"], function (
  require,
  exports,
  HTMLUtilities
) {
  ...
  var PublisherFont = /** @class */ (function () {
    ...
    PublisherFont.prototype.start = function () {
      var rootFrame = HTMLUtilities.findRequiredIframeElement(
        this.bookElement.contentDocument,
        "html"
      );
...
define("SerifFont", ["require", "exports", "HTMLUtilities"], function (
  require,
  exports,
  HTMLUtilities
) {
...
define("SansFont", ["require", "exports", "HTMLUtilities"], function (
  require,
  exports,
  HTMLUtilities
) {
...
define("SepiaTheme", ["require", "exports", "HTMLUtilities"], function (
  require,
  exports,
  HTMLUtilities
) {
...
define("NightTheme", ["require", "exports", "HTMLUtilities"], function (
  require,
  exports,
  HTMLUtilities
) {
...
define("ScrollingBookView", [
  "require",
  "exports",
  "BrowserUtilities",
  "HTMLUtilities",
], function (require, exports, BrowserUtilities, HTMLUtilities) {
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
              ...
              fetchManifest = function () {
                return __awaiter(_this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [4 /*yield*/, window.fetch(manifestUrl.href)];
                      case 1:
                        response = _a.sent();
                      ...
                      case 4:
                        return [
                          2 /*return*/,
                          new Manifest(manifestJSON, manifestUrl),
                        ];
                    }
                  });
                });
...
define("IFrameNavigator", [
  ...
  var upLinkTemplate = function (label, ariaLabel) {
    return (
      '\n  <a rel="up" aria-label="' +
      ariaLabel +
      '" tabindex="0">\n    <svg xmlns="http://www.w3.org/2000/svg" width="' +
  ...
  var IFrameNavigator = /** @class */ (function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                navigator.start(config.element, config.manifestUrl),
              ];
            case 1:
              _a.sent();
    ...
    IFrameNavigator.prototype.enableOffline = function () {
      if (
        this.cacher &&
        this.cacher.getStatus() !== Cacher_1.CacheStatus.Downloaded
      ) {
        this.cacher.enable();
      }
    };
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                Manifest_1.default.getManifest(this.manifestUrl, this.store),
              ];
            case 1:
              manifest = _a.sent();
              toc = manifest.toc;
              if (toc.length) {
                ...
                createTOC_1 = function (parentElement, links) {
                  ...
                  if (lastLink) {
                    _this.setupModalFocusTrap(
                      _this.tocView,
                      _this.contentsControl,
                      lastLink
                    );
                  }
    ...
    IFrameNavigator.prototype.showElement = function (element, control) {
      ...
      if (control) {
        ...
        if (closeIcon) {
          var newIconClass = (closeIcon.getAttribute("class") || "").replace(
            " inactive-icon",
            ""
          );
    ...
    IFrameNavigator.prototype.hideElement = function (element, control) {
      ...
      if (control) {
        ...
        var openIcon = control.querySelector(".icon.open");
        if (openIcon) {
          var newIconClass = (openIcon.getAttribute("class") || "").replace(
            " inactive-icon",
            ""
          );
          openIcon.setAttribute("class", newIconClass);
    ...
    IFrameNavigator.prototype.setActiveTOCItem = function (resource) {
      ...
      var activeItem = this.tocView.querySelector(
        'li > a[href^="' + resource + '"]'
      );
      if (activeItem) {
    ...
    IFrameNavigator.prototype.navigate = function (readingPosition) {
      ...
      if (readingPosition.resource.indexOf("#") === -1) {
        ...
        var newResource = readingPosition.resource.slice(
          0,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                this.store.get(LocalAnnotator.LAST_READING_POSITION),
              ];
            case 1:
...
define("LocalStorageStore", ["require", "exports", "MemoryStore"], function (
  require,
  exports,
  MemoryStore_1
) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [3 /*break*/, 3];
            case 1:
              return [4 /*yield*/, this.fallbackStore.get(key)];
            case 2:
              value = _a.sent();
              _a.label = 3;
            case 3:
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [3 /*break*/, 3];
            case 1:
              return [4 /*yield*/, this.fallbackStore.set(key, value)];
            case 2:
              _a.sent();
              _a.label = 3;
            case 3:
...
define("ServiceWorkerCacher", [
  "require",
  "exports",
  "Cacher",
  "Manifest",
], function (require, exports, Cacher_2, Manifest_2) {
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.verifyAndCacheManifest(this.manifestUrl),
              ];
            case 2:
              _a.sent();
              this.cacheStatus = Cacher_2.CacheStatus.Downloaded;
    ...
    ServiceWorkerCacher.prototype.cacheUrls = function (urls, manifestUrl) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, window.caches.open(manifestUrl.href)];
            case 1:
              cache = _a.sent();
              return [
                2 /*return*/,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                Manifest_2.default.getManifest(manifestUrl, this.store),
              ];
            case 1:
              manifest = _a.sent();
              promises = [
...
define("app", [
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  var app = function (element, manifestUrl) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            bookStore = new LocalStorageStore_1.default({
              prefix: manifestUrl.href,
            });
            cacher = new ServiceWorkerCacher_1.default({
              store: bookStore,
            ...
            settingsStore = new LocalStorageStore_1.default({
              prefix: "cassis-reader",
            });
            return [
              4 /*yield*/,
              BookSettings_1.default.create({
                store: settingsStore,
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              IFrameNavigator_1.default.create({
                element: element,
                manifestUrl: manifestUrl,
                store: bookStore,
                cacher: cacher,
