...
var serverManifestJson = require("r2-streamer-js/dist/es5/src/http/server-manifestjson")
  .serverManifestJson;
var serverMediaOverlays = require("r2-streamer-js/dist/es5/src/http/server-mediaoverlays")
  .serverMediaOverlays;
var serverPub = require("r2-streamer-js/dist/es5/src/http/server-pub")
  .serverPub;
var remoteServerPub = require("r2-streamer-js/dist/es5/src/http/server-url")
  .serverRemotePub;
var serverAssets = require("r2-streamer-js/dist/es5/src/http/server-assets")
  .serverAssets;
var Server = require("r2-streamer-js/dist/es5/src/http/server").Server;

var encodeURIComponent_RFC3986 = require("r2-utils-js/dist/es5/src/_utils/http/UrlUtils")
...
class RemoteEpubServer extends Server {
  constructor() {
    ...
    this.expressApp.use(
      "/readerNYPL",
      express.static(__dirname + "/../../viewer", { extensions: ["js"] })
    );
    ...
    this.expressApp.get("/pub", (req, res) => {
      ...
      const queryUrl =
        prefix + req.headers.host + "/pub/" + valueStr + "/manifest.json";
