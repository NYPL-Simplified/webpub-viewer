export const WIDTH_ATTR = 24;
export const HEIGHT_ATTR = 24;
export const VIEWBOX_ATTR = `0 0 25 25`;
...
) => `<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" role="img" class="${classAttr}">
  <defs>
...
const iconUse = (
  id: string,
  classAttr: string
) => `<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" class="${classAttr}" role="img" aria-labelledby="${id}">
